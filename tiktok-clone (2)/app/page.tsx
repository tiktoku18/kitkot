...
const generateVideoData = (index: number): VideoData => {
  ...
  return {
    id: `video-${index}`,
    videoUrl: `https://fuck-dating.com/video_app/videos/1/${videoNumber}.mp4`,
    username,
...
export default function TikTokClone() {
  const [videos, setVideos] = useState<(VideoData | { type: "ad"; data: any })[]>([])
  ...
  const loadMoreVideos = useCallback(() => {
    const newVideos: (VideoData | { type: "ad"; data: any })[] = []
    ...
    <div className="h-screen bg-black text-white overflow-hidden">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-black bg-opacity-20 backdrop-blur-sm">
        <div className="flex items-center justify-between px-4 py-3">
          <Link href="https://cutt.ly/UrnyWAZi" className="text-red-500 font-bold">
            LIVES
          </Link>
        ...
        {videos.map((item, index) => (
          ...
          >
            {item.type === "ad" ? (
              ...
              <Link href="https://cutt.ly/UrnyWAZi" className="block h-full relative">
                <video
                ...
                <div className="absolute right-2 bottom-32 flex flex-col space-y-3">
                  ...
                  <Link href="https://cutt.ly/UrnyWAZi" className="relative" onClick={(e) => e.stopPropagation()}>
                  ...
                  {/* Share Button */}
                  <Link href="https://cutt.ly/UrnyWAZi" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="absolute bottom-28 left-4 right-24">
                  <Link href="https://cutt.ly/UrnyWAZi" className="block" onClick={(e) => e.stopPropagation()}>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-black border-t border-gray-800">
        <div className="flex items-center justify-around py-2">
          <Link href="https://cutt.ly/UrnyWAZi" className="flex flex-col items-center p-2">
          ...
          <Link href="https://cutt.ly/UrnyWAZi" className="flex flex-col items-center p-2 relative">
                  ...
                  <div key={comment.id} className="flex space-x-3 mb-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-1">
                        <Link href="https://cutt.ly/UrnyWAZi" className="font-semibold text-sm text-black hover:underline">
                          {comment.username}
                        </Link>
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <Link href="https://cutt.ly/UrnyWAZi">
